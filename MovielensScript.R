...
if(!require(tidyr))      install.packages("data.table", repos = "http://cran.us.r-project.org")
if(!require(scales))     install.packages("data.table", repos = "http://cran.us.r-project.org")
if(!require(tidytext))   install.packages("data.table", repos = "http://cran.us.r-project.org")
